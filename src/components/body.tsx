                ...
                {isDropdownOpen && (
                  <div className="absolute bottom-full left-0 z-50 mb-3 w-48 rounded-xl border border-gray-700 bg-[#1A1A1A] p-1 shadow-xl">
                    <div className="max-h-48 overflow-y-auto rounded-lg bg-[#121212]">
                      <div className="cursor-default rounded-t-lg bg-[#222] px-4 py-2 text-center font-urbanist text-xs lg:text-sm text-[#E0E0E0]">Polymarket</div>
                      <div className="cursor-pointer rounded-b-lg px-4 py-2 text-center font-urbanist text-xs lg:text-sm text-[#E0E0E0] hover:bg-[#222]" onClick={() => { setIsDropdownOpen(false); navigate('/crypto') }}>Crypto</div>
                    </div>
                  </div>
                )}
              </div>
                  ...
                  <div className="absolute bottom-full left-0 z-50 mb-3 w-48 rounded-xl border border-gray-700 bg-[#1A1A1A] p-1 shadow-xl">
                    <div className="max-h-48 overflow-y-auto rounded-lg bg-[#121212]">
                      {['High','Medium','Low'].map(v => (
                        <div key={v} className="px-4 py-2 text-center font-urbanist text-xs lg:text-sm text-[#E0E0E0] hover:bg-[#222] cursor-pointer" onClick={() => { setSelectedLiquidity(v); setIsLiquidityOpen(false) }}>{v}</div>
                      ))}
                    </div>
                  </div>
                )}
              ...
              <div className="relative" ref={volumeRef}>
                ...
                {isVolumeOpen && (
                  <div className="absolute bottom-full left-0 z-50 mb-3 w-48 rounded-xl border border-gray-700 bg-[#1A1A1A] p-1 shadow-xl">
                    <div className="max-h-48 overflow-y-auto rounded-lg bg-[#121212]">
                      {['High','Medium','Low'].map(v => (
                        <div key={v} className="px-4 py-2 text-center font-urbanist text-xs lg:text-sm text-[#E0E0E0] hover:bg-[#222] cursor-pointer" onClick={() => { setSelectedVolume(v); setIsVolumeOpen(false) }}>{v}</div>
                      ))}
                    </div>
                  </div>
                )}
                  ...
                  <div className="absolute bottom-full left-0 z-50 mb-3 w-48 rounded-xl border border-gray-700 bg-[#1A1A1A] p-1 shadow-xl">
                    <div className="max-h-48 overflow-y-auto rounded-lg bg-[#121212]">
                      {['1h','4h','12h','24h','3d','7d','30d','90d','YTD','1y'].map(v => (
                        <div key={v} className="px-4 py-2 text-center font-urbanist text-xs lg:text-sm text-[#E0E0E0] hover:bg-[#222] cursor-pointer" onClick={() => { setSelectedTimeframe(v); setIsTimeframeOpen(false) }}>{v}</div>
                      ))}
                    </div>
                  </div>
                )}
                  ...
                  <div className="absolute bottom-full left-0 z-50 mb-3 w-48 rounded-xl border border-gray-700 bg-[#1A1A1A] p-1 shadow-xl">
                    <div className="max-h-48 overflow-y-auto rounded-lg bg-[#121212]">
                      {['Today','This Week','This Month'].map(v => (
                        <div key={v} className="px-4 py-2 text-center font-urbanist text-xs lg:text-sm text-[#E0E0E0] hover:bg-[#222] cursor-pointer" onClick={() => { setSelectedNewest(v); setIsNewestOpen(false) }}>{v}</div>
                      ))}
                    </div>
                  </div>
                )}
                  ...
                  <div className="absolute bottom-full left-0 z-50 mb-3 w-48 rounded-xl border border-gray-700 bg-[#1A1A1A] p-1 shadow-xl">
                    <div className="max-h-48 overflow-y-auto rounded-lg bg-[#121212]">
                      {['1h','6h','12h','24h','3d','7d'].map(v => (
                        <div key={v} className="px-4 py-2 text-center font-urbanist text-xs lg:text-sm text-[#E0E0E0] hover:bg-[#222] cursor-pointer" onClick={() => { setSelectedEndingSoon(v); setIsEndingSoonOpen(false) }}>{v}</div>
                      ))}
                    </div>
                  </div>
                )}
                  ...
                  <div className="absolute bottom-full left-0 z-50 mb-3 w-48 rounded-xl border border-gray-700 bg-[#1A1A1A] p-1 shadow-xl">
                    <div className="max-h-48 overflow-y-auto rounded-lg bg-[#121212]">
                      {['Logical','Sentiment'].map(v => (
                        <div key={v} className="px-4 py-2 text-center font-urbanist text-xs lg:text-sm text-[#E0E0E0] hover:bg-[#222] cursor-pointer" onClick={() => { setSelectedScore(v); setIsScoreOpen(false) }}>{v}</div>
                      ))}
                    </div>
                  </div>
                )}
